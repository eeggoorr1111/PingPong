...
{
    public sealed class NetworkLobby : MonoBehaviourPunCallbacks, IOnEventCallback
    {
        ...
        {
            PhotonPeer.RegisterType(typeof(ReflectBallData), 0, ReflectBallData.Serialize, ReflectBallData.Deserialize);
            PhotonPeer.RegisterType(typeof(LosedBallData), 1, LosedBallData.Serialize, LosedBallData.Deserialize);
            PhotonPeer.RegisterType(typeof(StartedGameData), 2, StartedGameData.Serialize, StartedGameData.Deserialize);
