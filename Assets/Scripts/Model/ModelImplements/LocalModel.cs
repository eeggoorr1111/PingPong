...
{
    public sealed class LocalModel : IModel
    {
        public LocalModel(  (IPlayer, RacketModel) meWithRacket,
        ...
        private void OnReflectedBall(IPlayer reflector, Vector2 ricochetDir)
        {
            ...
            ReflectedBall.Invoke(new ReflectBallData(reflector.Id, Ball.Trajectory));
        }
        private void OnLosedBall(IPlayer loser)
        {
            ...
            LoseBall.Invoke(new LosedBallData(loser.Id, Ball.Diameter, Ball.Speed, Ball.Trajectory));
        }
