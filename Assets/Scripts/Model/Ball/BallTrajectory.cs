...
namespace PingPong.Model.Ball
{
    ...
    {
        public static BallTrajectory Deserialize(byte[] bytes, int startByte)
        {
            ...
            return new BallTrajectory(corners, timeBeginFly, timeEndFly);
        }
        public static byte[] Serialize(BallTrajectory trajectory)
        {
        ...
        public BallTrajectory(Vector2[] corners, double timeBeginFly, double timeEndFly)
        {
            _corners = corners;
